...
// ✅ สร้าง Interface สำหรับ Config ของ Modal เพื่อเลิกใช้ any
...
export default function UserManager() {
    ...
    // ✅ 2. แก้ไข Type ของ State จาก any เป็น ModalConfig (หรือ Partial)
    ...
    const handleStatusChange = async (id: number, newStatus: string) => {
        try {
            ...
            // ✅ 3. แก้ไข catch (err: any) เป็น AxiosError
