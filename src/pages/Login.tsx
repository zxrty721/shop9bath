...
export default function Login() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // โดยระบุว่า response.data จะมีหน้าตาเป็น Object ที่มี key "error" เป็น string
    ...
    return (
        // ✅ พื้นหลัง: Light=Zinc-100 / Dark=Zinc-Gradient
        <div className="min-h-screen flex items-center justify-center bg-zinc-100 dark:bg-linear-to-br dark:from-zinc-900 dark:via-black dark:to-zinc-900 font-prompt p-4 relative overflow-hidden transition-colors duration-500">
            ...
            <div className="bg-white dark:bg-zinc-900/90 backdrop-blur-xl p-8 rounded-3xl shadow-2xl w-full max-w-[400px] z-10 border border-zinc-200 dark:border-zinc-800 animate-fade-in relative transition-colors duration-300">
                <div className="text-center mb-8">
                    ...
                    <p className="text-zinc-500 dark:text-zinc-400 text-xs mt-1.5 uppercase tracking-widest font-semibold">
                        Enterprise Login
                    </p>
                </div>
                ...
                <form onSubmit={handleLogin} className="space-y-5">
                    <div className="relative group">
                        <User
                            className="absolute left-4 top-3.5 text-zinc-400 group-focus-within:text-indigo-600 dark:group-focus-within:text-indigo-400 transition-colors z-10"
                            size={20}
                        />
                        <input
                            type="text"
                ...
                <div className="mt-8 text-center border-t border-zinc-100 dark:border-zinc-800 pt-6">
                    ...
                    <Link
                        to="/register"
                        className="text-indigo-600 dark:text-indigo-400 font-bold hover:underline text-sm ml-1 transition-colors"
                    >
                        สมัครสมาชิกใหม่
                    </Link>
                </div>
